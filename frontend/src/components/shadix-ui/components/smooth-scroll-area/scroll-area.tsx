...
import { LenisProvider } from "@/components/shadix-ui/components/smooth-scroll-area/lenis-context";
import Scrollbar from "@/components/shadix-ui/components/smooth-scroll-area/scrollbar";
